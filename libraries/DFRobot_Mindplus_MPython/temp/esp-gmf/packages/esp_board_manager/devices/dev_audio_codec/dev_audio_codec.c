...
#ifdef CONFIG_ESP_BOARD_PERIPH_I2S_SUPPORT
        // This is a temporary change for ADC initialization.
        // I2S Clock is generated by TX, when creating codec_dev_data_if, a TX handle needs to be provided
        uint8_t *i2s_chan_handles_ptr = i2s_chan_handles;
        i2s_chan_handle_t *temp = (i2s_chan_handle_t *)(i2s_chan_handles_ptr + (codec_cfg->i2s_cfg.port * 12) + 4);
        i2s_cfg.tx_handle = *temp;
#endif /* CONFIG_ESP_BOARD_PERIPH_I2S_SUPPORT */
