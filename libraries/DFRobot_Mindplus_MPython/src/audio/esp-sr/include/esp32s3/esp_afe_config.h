...
typedef struct {
    ...
    afe_mode_t afe_mode;         // The mode of afeï¼?AFE_MODE_LOW_COST or AFE_MODE_HIGH_PERF
    afe_type_t afe_type;         // The mode of afeï¼?AFE_MODE_LOW_COST or AFE_MODE_HIGH_PERF
