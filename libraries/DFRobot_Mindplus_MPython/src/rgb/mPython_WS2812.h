...
#ifndef __mPython_WS2812_H
#define __mPython_WS2812_H
...
enum mPython_LED_TYPE
{                     //R  G  B
    mPython_TYPE_RGB = 0x06,  //00 01 10
    mPython_TYPE_RBG = 0x09,  //00 10 01
    mPython_TYPE_GRB = 0x12,  //01 00 10
    mPython_TYPE_GBR = 0x21,  //10 00 01
    mPython_TYPE_BRG = 0x18,  //01 10 00
    mPython_TYPE_BGR = 0x24   //10 01 00
};

class mPython_WS2812
{
protected:
...
public:
    mPython_WS2812(uint16_t n = 8, uint8_t gpio = 2, uint8_t chn = 0, mPython_LED_TYPE t = mPython_TYPE_GRB);

    bool begin();
    void setLedCount(uint16_t n);
    void setLedType(mPython_LED_TYPE t);
